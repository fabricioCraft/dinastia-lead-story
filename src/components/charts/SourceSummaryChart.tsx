...
import { useSummaryBySource } from '@/hooks/useSummaryBySource'
import { Badge } from '@/components/ui/badge'
import { useFilters } from '@/contexts/FilterContext'

const COLORS = ['#3B82F6','#10B981','#F59E0B','#EF4444','#8B5CF6','#06B6D4','#84CC16','#F97316','#22C55E','#EAB308']

export function SourceSummaryChart() {
  const { data, isLoading, error } = useSummaryBySource()
    ...
    return (
      <div className="h-80 flex items-center justify-center">
        <div className="text-center">
          <p className="text-red-600 mb-2">Erro ao carregar resumo por fonte</p>
  ...
  return (
    <div className="w-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 mt-4 w-full overflow-x-hidden">
        ...
        <div className="rounded-xl bg-muted/40 border border-border/50 p-4">
          <p className="text-xs text-muted-foreground mb-2">Principal Fonte</p>
